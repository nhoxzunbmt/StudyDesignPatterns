...
abstract class AbstractBookFactory {
	...
	abstract function makePythonBook();
}
...
class OReillyBookFactory extends AbstractBookFactory {
	...
	function makePythonBook() {
		return new OReillyPythonBook();
	}
}
...
class SamsBookFactory extends AbstractBookFactory {
	...
	function makePythonBook() {
		// TODO: Implement makePythonBook() method.
	}
}
...
abstract class AbstractPythonBook extends AbstractBook {
	private $subject = "Python";
}

class OReillyPythonBook extends AbstractPythonBook {
	private $author;
	private $title;
	function __construct() {
		$this->author = 'George Reese, Randy Jay Yarger, and Tim King';
		$this->title = 'Managing and Using Python';
	}
	function getAuthor() {
		return $this->author;
	}
...
class SamsPythonBook extends AbstractPythonBook {
	private $author;
	private $title;
	function __construct() {
		$this->author = 'Paul Dubois';
		$this->title = 'Python, 3rd Edition';
	}
	function getAuthor() {
		return $this->author;
	}
...
function testConcreteFactory($bookFactoryInstance)
{
	...
	$mySqlBook = $bookFactoryInstance->make();
	writeln('MySQL Author: '.$mySqlBook->getAuthor());
	writeln('MySQL Title: '.$mySqlBook->getTitle());
}
